...
// attributes. Only keys that already exist as attributes on the asset are written
// (the operator picks the subset the meter reports); unknown keys are ignored so
// the manager never rejects an event for a missing attribute.
rules.add()
